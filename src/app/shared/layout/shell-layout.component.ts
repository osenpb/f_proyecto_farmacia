...
const IC = {
  ...
  anuncios:     'M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z',
};
...
const NAV_BY_ROLE: Record<string, NavItem[]> = {
  ROLE_ADMIN: [
    ...
    { label: 'Anuncios',         path: '/anuncios',         icon: IC.anuncios },
  ],
  ROLE_GESTOR: [
    { label: 'Dashboard',        path: '/dashboard',        icon: IC.dashboard },
    { label: 'Notificaciones',   path: '/notificaciones',   icon: IC.notif },
